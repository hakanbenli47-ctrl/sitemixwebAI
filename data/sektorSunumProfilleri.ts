...
const sektorProfilleri: Record<string, SektorSunumProfili> = {
  kuafor: { ...bakim, varsayilanTema: "studio", hizmetSayfasiAdi: "Saç ve Bakım", hizmetSayfasiSlug: "sac-bakim", galeriSayfasiAdi: "Saç Modelleri", galeriSayfasiSlug: "sac-modelleri" },
  ...
  "guzellik-salonu": { ...bakim, varsayilanTema: "ruby", hizmetSayfasiAdi: "Bakım Uygulamaları", hizmetSayfasiSlug: "bakim-uygulamalari", galeriSayfasiAdi: "Salon ve Uygulamalar", galeriSayfasiSlug: "salon-uygulamalar" },
  ...
  temizlik: { ...sahaHizmeti, varsayilanTema: "aurora", hizmetSayfasiAdi: "Temizlik Hizmetleri", hizmetSayfasiSlug: "temizlik-hizmetleri", galeriSayfasiAdi: "Temizlik Uygulamaları", galeriSayfasiSlug: "temizlik-uygulamalari" },
  "koltuk-yikama": { ...sahaHizmeti, varsayilanTema: "lagoon", hizmetSayfasiAdi: "Koltuk Yıkama", hizmetSayfasiSlug: "koltuk-yikama", galeriSayfasiAdi: "Öncesi ve Sonrası", galeriSayfasiSlug: "koltuk-temizligi" },
  "hali-yikama": { ...sahaHizmeti, varsayilanTema: "lagoon", hizmetSayfasiAdi: "Halı Yıkama", hizmetSayfasiSlug: "hali-yikama", galeriSayfasiAdi: "Yıkama Süreci", galeriSayfasiSlug: "hali-yikama-sureci" },
  ilaclama: { ...sahaHizmeti, varsayilanTema: "copper", hizmetSayfasiAdi: "İlaçlama Hizmetleri", hizmetSayfasiSlug: "ilaclama-hizmetleri", galeriKullan: false, aksiyonSayfasi: { ad: "İlaçlama Talebi", slug: "ilaclama-talebi", ustBaslik: "Güvenli ön değerlendirme", baslik: "Zararlı türünü ve alanı birlikte değerlendirelim" } },
  nakliyat: { ...sahaHizmeti, varsayilanTema: "sand", hizmetSayfasiAdi: "Taşıma Hizmetleri", hizmetSayfasiSlug: "tasima-hizmetleri", galeriSayfasiAdi: "Taşıma Süreci", galeriSayfasiSlug: "tasima-sureci" },
  "teknik-servis": { ...sahaHizmeti, varsayilanTema: "copper", hizmetSayfasiAdi: "Servis Hizmetleri" },
  "oto-yikama": { ...otomotiv, varsayilanTema: "obsidian", hizmetSayfasiAdi: "Bakım ve Koruma", hizmetSayfasiSlug: "oto-bakim", galeriSayfasiAdi: "Bakım Uygulamaları", galeriSayfasiSlug: "oto-bakim-uygulamalari" },
  "oto-detaylandirma": { ...otomotiv, varsayilanTema: "obsidian", hizmetSayfasiAdi: "Detaylı Araç Bakımı", hizmetSayfasiSlug: "oto-detaylandirma", galeriSayfasiAdi: "Detaylı Bakım İşleri", galeriSayfasiSlug: "detayli-bakim-uygulamalari" },
  "oto-servis": { ...otomotiv, varsayilanTema: "copper", hizmetSayfasiAdi: "Servis ve Bakım" },
  "arac-kaplama": { ...otomotiv, varsayilanTema: "obsidian", hizmetSayfasiAdi: "Kaplama ve Koruma", hizmetSayfasiSlug: "kaplama-koruma", galeriSayfasiAdi: "Kaplama Uygulamaları", galeriSayfasiSlug: "arac-kaplama-uygulamalari" },
  ...
  elektrikci: { ...sahaHizmeti, varsayilanTema: "copper", hizmetSayfasiAdi: "Elektrik Hizmetleri", hizmetSayfasiSlug: "elektrik-hizmetleri", galeriKullan: false, aksiyonSayfasi: { ad: "Servis Talebi", slug: "elektrik-servisi", ustBaslik: "Hızlı servis", baslik: "Arızayı ve konumu paylaşın" } },
  tesisatci: { ...sahaHizmeti, varsayilanTema: "skyline", hizmetSayfasiAdi: "Tesisat Hizmetleri", hizmetSayfasiSlug: "tesisat-hizmetleri", galeriKullan: false, aksiyonSayfasi: { ad: "Tesisatçı Çağır", slug: "tesisat-talebi", ustBaslik: "Hızlı servis", baslik: "Sorunu ve aciliyeti paylaşın" } },
  "kombi-servisi": { ...sahaHizmeti, varsayilanTema: "copper", hizmetSayfasiAdi: "Kombi Servisi", hizmetSayfasiSlug: "kombi-servisi", galeriKullan: false, aksiyonSayfasi: { ad: "Servis Talebi", slug: "kombi-servis-talebi", ustBaslik: "Kombi desteği", baslik: "Marka-model ve hata bilgisini paylaşın" } },
