...
const sektorler: SektorTanimi[] = [
  ...
  },
  {
    ...
    temalar: [t("tema-1", "Lacivert Kulüp", "Krem zemin, lacivert kulüp ve klasik kırmızı vurgu.", ["#f4efe5", "#08182d", "#c72b40", "#ffffff"]), t("tema-2", "Kömür Kulüp", "Kömür siyahı, sıcak krem ve miras kırmızısı.", ["#eee7dc", "#171b22", "#b9283e", "#fffaf2"]), t("tema-3", "Beyaz & Mavi", "Temiz, modern ve dinamik.", ["#f5f8fb", "#102540", "#1d70b7", "#ffffff"])],
    sayfalar: [{ ad: "Ana Sayfa", slug: "" }, { ad: "Menü", slug: "hizmet-menusu" }, { ad: "Ustalar", slug: "ustalar" }, { ad: "Kulüp", slug: "kulup" }, { ad: "Randevu", slug: "randevu" }],
    medyaSlotlari: [{ slot: "hero", baslik: "Ana koltuk ve mekân" }, { slot: "detay", baslik: "Kesim detayı" }, { slot: "ekip", baslik: "Usta ekibi" }],
    icerik: {
      rozet: "Klasik zanaat · modern bakım", slogan: "Keskin hatlar, temiz işçilik ve koltuğa ayrılmış gerçek zaman.", heroBaslik: "Tarzınızı aceleye getirmeyen kişisel bir bakım deneyimi.", heroAciklama: "Saç ve sakal formu yüz hatlarınıza göre planlanır. Sıcak havlu, bakım ve son dokunuşlar tek bir servis ritminde tamamlanır.", hakkimizdaBaslik: "Mahalle sıcaklığı, kulüp disiplini", hakkimizdaMetni: "Her müşterinin kesim notunu ve tercihlerini tanırız. Klasik usta geleneğini hijyen, randevu düzeni ve güncel tekniklerle bir araya getiririz.", guvenBasligi: "Steril ekipman ve kişisel servis", guvenMetni: "Her servis öncesi ekipman hazırlanır, tek kullanımlık ürünler yenilenir ve koltuk bir sonraki misafir için eksiksiz temizlenir.", ctaBaslik: "Koltuğunuzu ayıralım.", ctaMetni: "İstediğiniz hizmeti seçin; uygun usta ve süreyi birlikte planlayalım.",
      ...
      ozellikler: [["Üç renkli giriş imzası", "Kırmızı, beyaz ve mavi hareketli silindir markanın giriş işaretidir."], ["Usta seçimi", "Müsaitliğe göre tercih ettiğiniz koltuk planlanır."], ["Kesim hafızası", "Önceki numara ve form notları korunur."]],
...
const EK_GORSEL_ALANLARI: Partial<Record<YeniSektorKimligi, MedyaSlotuTanimi[]>> = {
  ...
  berber: [
    ...
    { slot: "galeri-3", baslik: "Kulüp atmosferi" },
